...
const COPY = {
  ...
  ar: {
    lead: (renter: string) =>
      `${renter} يتعامل معك بالفعل ويستخدم معداتك لإدارة تأجير المعدات. انضم لتصلك طلباته داخل التطبيق، مع متجرك وأسطولك ومستنداتك في مكان واحد.`,
    leadNoName:
      "المستأجر الذي تتعامل معه يستخدم معداتك لإدارة تأجير المعدات. انضم لتصلك طلباته داخل التطبيق، مع متجرك وأسطولك ومستنداتك في مكان واحد.",
