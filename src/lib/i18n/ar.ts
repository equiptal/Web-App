...
export const ar: Dictionary = {
  ...
  manual: {
    step2Title: "إضافة معدات",
    step2Sub: "اختر من الكتالوج — الفئة، ثم النوع، ثم الحجم.",
    pickCategory: "اختر فئة",
    pickSubcategory: "اختر نوعًا",
    pickMeasurement: "اختر الحجم",
    category: "الفئة",
    subcategory: "النوع",
    measurement: "الحجم",
    quantity: "الكمية",
    ...
    fuelElectric: "كهرباء",
    notes: "ملاحظات",
    notesPlaceholder: "أي تفاصيل إضافية لهذا العنصر…",
    addItem: "إضافة عنصر آخر",
    item: "عنصر",
    remove: "إزالة",
    removeConfirm: "إزالة هذا العنصر؟",
    confirmRemove: "إزالة",
    cancel: "إلغاء",
