...
export const en = {
  ...
  profile: {
    ...
    companyLogoNote: "Appears on your quotations, your shared request link, and the bid form suppliers open.",
    companyLogoUpload: "Upload",
    companyLogoChange: "Change",
    companyLogoRemove: "Remove",
    companyLogoError: "Could not upload that image. Please try another.",
    save: "Save changes",
    saving: "Saving…",
