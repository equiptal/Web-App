...
export const en = {
  ...
  suppliers: {
    ...
    inviteRecorded: "Copy pastes the full card, with the app links, into Gmail or Outlook. WhatsApp and e-mail are recorded on their history; SMS and Copy are not.",
