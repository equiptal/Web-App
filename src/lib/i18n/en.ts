...
export const en = {
  ...
  intake: {
    postShare: {
      ...
      yourLine: "A line of your own",
      yourLineHint: "Optional. Added above the request details.",
      preview: "What they receive",
      previewPending: "Fills in once the request is posted and the link exists.",
  ...
  projects: {
    ...
    chips: {
      hint: "Pick a site, and half of this fills itself in",
      label: "Project",
      ended: "ended",
      all: "All projects",
    },
  ...
  suppliers: {
    ...
    yourLine: "A line of your own",
    yourLineHint: "Optional. Added above the request details.",
    shareSubtitle: "Pick the request, pick who sees it.",
    whichRequest: "Which request",
    noRequests: "You have no requests to share yet.",
    whatTheyGet: "What they receive",
    shareSubject: "A new equipment request for you {code}",
    shareCount: "{n} will be sent to",
    sharePickOne: "Pick at least one supplier with an e-mail",
    shareSkipped: "{n} skipped",
    shareSend: "Send to {n}",
    shareSendNone: "Send",
    sharedOne: "Request shared with 1 supplier",
    sharedMany: "Request shared with {n} suppliers",
    addEmailShort: "Add e-mail",
