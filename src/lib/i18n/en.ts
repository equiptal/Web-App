...
export const en = {
  ...
  intake: {
    postShare: {
      ...
      copyAddresses: "Copy the addresses",
      addressesCopied: "Copied · paste into Bcc",
      whatsappDraws: "WhatsApp also shows",
      outlookPasteBcc: "Outlook cannot take recipients from a link, so its window opens empty. Put your {n} suppliers in Bcc yourself:",
