...
export const en = {
  ...
  suppliers: {
    ...
    addTitle: "Add my own suppliers",
    addSubtitle: "Suppliers you work with who are not on Moedatech yet.",
    ...
    addSupplier: "Add my own suppliers",
    ...
    inviteRecorded: "WhatsApp and e-mail are recorded on their history. SMS and Copy are not.",
    ...
    rSameName: "same name as a supplier you have, but a different phone and e-mail — added as a separate row. If it is the same firm, delete one.",
