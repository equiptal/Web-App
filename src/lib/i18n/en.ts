...
export const en = {
  ...
  intake: {
    postShare: {
      ...
      unfurl: "The link opens as",
      previewEmpty: "Add equipment to your request to see what suppliers receive.",
      previewNoLink: "The link is added the moment you post.",
      ...
      editWording: "Edit the wording",
      edited: "Edited",
      editWordingHint: "Your words around the request. Saved on this browser, so every request you send uses them.",
      tplGreeting: "Greeting",
      tplIntro: "Introduction",
      tplSignoff: "Sign-off",
      tplNameToken: "Type {name} anywhere to drop in your company name.",
