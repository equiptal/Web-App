...
export const en = {
  ...
  intake: {
    postShare: {
      ...
      stepOutlook: "Outlook cannot take recipients from a link. When it opens, paste your {n} suppliers into Bcc — they will be on your clipboard.",
      stepOutlookNone: "Outlook cannot take recipients from a link. Its window will open empty, for you to address.",
      stepGmail: "Gmail fills the recipients in for you. When it opens, paste the card at the end of the message — it will be on your clipboard.",
