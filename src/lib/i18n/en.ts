...
export const en = {
  ...
  intake: {
    postShare: {
      ...
      confirmTitle: "Send this e-mail?",
      confirmBodyOutlook: "It goes out through your Outlook, from {from}, to {n} suppliers",
      confirmBodyGmail: "It goes out through your Gmail, from {from}, to {n} suppliers",
      confirmBodyOne: "It goes out from {from} to 1 supplier",
      confirmYes: "Send",
      confirmNo: "Cancel",
