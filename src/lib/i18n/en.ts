...
export const en = {
  ...
  projects: {
    ...
    workOrder: {
      ...
      overrideOpen: "Different terms for this machine",
      overrideTitle: "This machine only",
      overrideBadge: "{n} different",
      followShared: "Follow the shared terms",
      termsTitle: "Terms for this order",
      termsSub: "answered once — every machine you add inherits them",
      operator: "Operator",
