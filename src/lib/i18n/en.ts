...
export const en = {
  ...
  projects: {
    ...
    file: {
      ...
      askBody: "Filing it here changes nothing about the request â not its location, its dates or its terms. The site is only where you file it.",
      askContinue: "File it here anyway",
      askEdit: "Change the requestâs location",
