...
export const en = {
  ...
  manual: {
    step2Title: "Add equipment",
    step2Sub: "Pick from the catalogue — category, type, then size.",
    pickCategory: "Select a category",
    pickSubcategory: "Select a type",
    pickMeasurement: "Select a size",
    category: "Category",
    subcategory: "Type",
    measurement: "Size",
    quantity: "Quantity",
    ...
    notes: "Notes",
    notesPlaceholder: "Any extra detail for this item…",
