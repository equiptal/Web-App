// DISABLED — the multi-item RFQ detail page, replaced by the requests workspace at /requests.
...
//                 <div style={{ margin: "0 0 10px", padding: "8px 12px", borderRadius: "var(--radius-md)", background: "var(--brand-soft)", border: "1px solid var(--brand-pale)", fontSize: 12.5, fontWeight: 700, lineHeight: 1.5, color: "var(--brand-deep)" }}>{cancelBlockedReason(rec.status, ar)}</div>
//               )}
