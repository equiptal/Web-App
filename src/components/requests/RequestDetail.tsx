...
//         {isTrial && (
//           <span className="typebadge" style={{ background: "color-mix(in srgb, var(--brand) 12%, transparent)", color: "var(--brand-deep)", borderColor: "color-mix(in srgb, var(--brand) 35%, transparent)" }}>
...
//       {isTrial && (
//         <div className="rd-track" style={{ marginTop: 8, background: "color-mix(in srgb, var(--brand) 7%, transparent)", borderColor: "color-mix(in srgb, var(--brand) 35%, transparent)" }}>
//           <span className="material-icons-outlined" style={{ color: "var(--brand-deep)" }}>info</span>
...
//       <div className="w-full max-w-sm rounded-lg bg-[var(--surface1)] p-5 text-center" onClick={(e) => e.stopPropagation()}>
...
//   return (
//     <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4" dir={ar ? "rtl" : "ltr"} onClick={onClose}>
//       <div className="flex max-h-[90vh] w-full max-w-2xl flex-col rounded-lg bg-[var(--surface1)]" onClick={(e) => e.stopPropagation()}>
//         <div className="flex items-center justify-between border-b border-[var(--border)] px-5 py-4">
//           <h3 className="text-title font-extrabold text-[var(--navy)]">{L("Edit request", "تعديل الطلب")}</h3>
...
//           <button className="rounded-sm bg-[var(--action)] px-5 py-2.5 text-body font-semibold text-white disabled:bg-disabled-bg disabled:text-disabled-fg" disabled={busy} onClick={save}>{busy ? L("Saving…", "جارٍ الحفظ…") : L("Save changes", "حفظ التغييرات")}</button>
//         </div>
//       </div>
//     </div>
//   );
