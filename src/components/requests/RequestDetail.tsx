...
//       <div className="w-full max-w-sm rounded-lg bg-surface p-5 text-center" onClick={(e) => e.stopPropagation()}>
...
//   return (
//     <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4" dir={ar ? "rtl" : "ltr"} onClick={onClose}>
//       <div className="flex max-h-[90vh] w-full max-w-2xl flex-col rounded-lg bg-surface" onClick={(e) => e.stopPropagation()}>
//         <div className="flex items-center justify-between border-b border-border px-5 py-4">
//           <h3 className="text-title font-extrabold text-navy">{L("Edit request", "تعديل الطلب")}</h3>
//           <button onClick={onClose} className="text-muted"><span className="material-icons-outlined">close</span></button>
//         </div>
//
