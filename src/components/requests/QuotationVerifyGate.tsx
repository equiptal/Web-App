      ...
      <div className="w-full max-w-[440px] rounded-t-2xl bg-surface p-5 shadow-xl sm:rounded-2xl">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-[17px] font-extrabold text-navy">{L("Your account isn't verified yet", "لم يتم توثيق حسابك بعد")}</h3>
        ...
        <div className="mt-5 flex flex-col-reverse gap-2.5 sm:flex-row sm:justify-end">
          <button onClick={onContinue} className="rounded-[10px] border border-border bg-surface px-4 py-2.5 text-[13.5px] font-bold text-navy-mid transition hover:bg-surface2">
            {L("Continue without it", "المتابعة بدون ذلك")}
          </button>
          <button onClick={onVerify} className="inline-flex items-center justify-center gap-1.5 rounded-[10px] bg-brand px-5 py-2.5 text-[13.5px] font-bold text-white">
