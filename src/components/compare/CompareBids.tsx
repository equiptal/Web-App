...
//     const css = `*{box-sizing:border-box;margin:0;padding:0;}body{font-family:'Inter','Segoe UI',Roboto,sans-serif;color:var(--navy);padding:22px;-webkit-print-color-adjust:exact;print-color-adjust:exact;}h1{font-size:20px;font-weight:900;}.head{display:flex;justify-content:space-between;align-items:baseline;border-bottom:2px solid var(--navy);padding-bottom:10px;margin-bottom:14px;}.head .d{font-size:12px;color:var(--muted);font-weight:700;}.basket{background:var(--brand-soft);border:1px solid var(--brand-pale);border-radius: var(--radius-md);padding:10px 14px;margin-bottom:16px;font-size:13px;font-weight:700;}.basket b{color:var(--brand);}.cmp-doc{margin-bottom:22px;page-break-inside:avoid;}.cmp-doc h2{font-size:15px;font-weight:800;margin-bottom:8px;}.cmp-doc h2 small{font-size:11.5px;font-weight:600;color:var(--muted);}table{width:100%;border-collapse:collapse;font-size:12px;}th,td{border:1px solid var(--surface3);padding:7px 9px;text-align:start;}thead th{background:var(--navy);color:var(--surface);font-weight:800;font-size:11.5px;}thead th.lbl{background:var(--surface);}td.lbl{background:var(--surface);font-weight:700;color:var(--muted);width:200px;}tr.bh td{font-weight:800;font-size:11px;text-transform:uppercase;letter-spacing:.04em;}tr.bh.p td{background:color-mix(in srgb, var(--brand) 10%, transparent);color:var(--brand-deep);}tr.bh.q td{background:color-mix(in srgb, var(--info) 10%, transparent);color:var(--info);}tr.bh.c td{background:color-mix(in srgb, var(--ok) 10%, transparent);color:var(--ok-deep);}td.win{background:color-mix(in srgb, var(--ok) 12%, transparent);}.ok{color:var(--ok-deep);font-weight:800;}.no{color:var(--danger);font-weight:800;}.soft{color:var(--muted-light);}.sum{background:var(--background);border:1px solid var(--info-soft);border-radius: var(--radius-sm);padding:9px 12px;margin-top:8px;}.sum-h{font-size:11.5px;font-weight:800;color:var(--info);margin-bottom:4px;}.sum ul{padding-inline-start:18px;}.sum li{font-size:12px;font-weight:600;color:var(--navy-mid);line-height:1.5;}@media print{body{padding:0;}}`;
