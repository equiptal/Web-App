      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12, padding: "0 2px", gap: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, fontWeight: 600, color: "var(--muted)" }}>{L(`Step ${step + 1} of 4`, `الخطوة ${step + 1} من 4`)} · {sc.tag}</div>
          </div>
        </div>
  ...
  return (
    <div style={{ position: "absolute", inset: 0, padding: "18px 20px", animation: "rlv-fade .35s ease both" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 11 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: "var(--navy-deep)" }}>{L("Forklift · 10 ton: 3 bids", "رافعة شوكية · 10 طن: 3 عروض")}</span>
        <span style={{ fontSize: 10, fontWeight: 800, color: "var(--ok-deep)", background: "var(--ok-soft)", padding: "3px 8px", borderRadius: "var(--radius-lg)" }}>{L("1/1 fulfilled", "1/1 مكتمل")}</span>
      </div>
