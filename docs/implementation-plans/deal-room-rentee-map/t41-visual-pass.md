...
| **D2** | A machine with **no photo** | C15, E3 |
...
- **Real fleet data** — real distances, real yard names, real taxonomy PNGs, real photo aspect ratios.
  M2, C1 and C15 are only meaningful against real assets.
...
## D · The panel header, the counts and the shortfall
...
## J · The chat dock and its notice
